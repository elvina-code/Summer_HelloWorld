...
import oop.Inheritance.Restaurant.Food;
import oop.Inheritance.Restaurant.RestarauntDemoApp;
import oop.Inheritance.Restaurant.User;
...
public class RestaurantDemoAppTest {
    RestarauntDemoApp restaurantDemoApp = new RestarauntDemoApp();
    @Test
